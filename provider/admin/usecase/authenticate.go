...
func (a *Authenticate) Perform(ctx provider.Context, userID int, allowedRole []constant.UserRole, userProvider provider.User) (entity.User, *entity.ApplicationError) {
	user, err := userProvider.Find(ctx, userID)
