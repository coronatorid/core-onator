...
// Find user by id
func (u *User) Find(ctx context.Context, ID int) (entity.User, *entity.ApplicationError) {
	find := usecase.Find{}
	return find.Perform(ctx, ID, u.db)
}

// FindByPhoneNumber find user by phone number
func (u *User) FindByPhoneNumber(ctx context.Context, phoneNumber string) (entity.User, *entity.ApplicationError) {
	findByPhoneNumber := usecase.FindByPhoneNumber{}
	return findByPhoneNumber.Perform(ctx, phoneNumber, u.db)
}

// Create user
func (u *User) Create(ctx context.Context, userInsertable entity.UserInsertable) (int, *entity.ApplicationError) {
	create := usecase.Create{}
	return create.Perform(ctx, userInsertable, u.db)
}

// CreateOrFind user based on its phone number
func (u *User) CreateOrFind(ctx context.Context, phoneNumber string) (entity.User, *entity.ApplicationError) {
